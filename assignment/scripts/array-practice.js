...
let favoriteFoods = ['Fajitas', 'Pad Thai', 'Pho', 'Chipotle'];
...
favoriteFoods.push('Sunflower Seeds');
...
console.log(`Sabrina's Favorite foods are now`, favoriteFoods);
...
favoriteFoods.unshift('Breakfast Nachos');
